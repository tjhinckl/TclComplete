...
==============================================================================
## Support for Mentor Tessent shell
This tool also includes support for Mentor Tessent shell. This can be
generated by running tessent and sourcing the script
`tcl/WriteTclCompleteMentor.tcl`. Then execute the command
`tshell::build_all_json <directory>`. This will generate collateral
files for all Tessent shell commands. Point your auto completion
plugin to this area and it will work same as the synopsys based one.
